...
public class InternshipController {
    ...
    @GetMapping
    public ResponseEntity<?> getAllInternshipsWithFilters(
        ...
        PageResponseDTO<Internship> internships =
                internshipService.getAllInternshipsWithFilters(levels, types, payments, search, page, size);
    ...
    @GetMapping("{id}")
    public ResponseEntity<?> getSingleInternship(@PathVariable Long id) {
        return responseHandler.wrapResponse(
                internshipService.getInternshipResponse(internshipService.getSingleInternship(id)),
